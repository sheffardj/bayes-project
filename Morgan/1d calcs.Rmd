...
s1<- est.calc( un, 3.16, 5, 'unif')
 s2<-est.calc( nor, 3.16,5, 'norm')
# s3<- est.calc( bet, 3.16)
 s4<-est.calc( sn, 3.16, 5,'skewnorm')


ggarrange(s1,s2,s4, ncol = 2,nrow = 2)
...
ggarrange(s5,s6,s8, ncol = 2,nrow = 2)
```
...
ggarrange(s9,s10,s12, ncol = 2,nrow = 2)
```
...
ggarrange(m1,m2,m4, ncol = 2,nrow = 2)
```
...
ggarrange(m5,m5,m8, ncol = 2,nrow = 2)
```

# mu = 2
```{r}
m9<-est.mu( un,  2,10, 'unif')
m10<-est.mu( nor, 2,10, 'norm')
# m11<-est.mu( bet, 2)
m12<- est.mu( sn,  2, 10, 'skewnorm')

ggarrange(m9,m10,m12, ncol = 2,nrow = 2)
```
